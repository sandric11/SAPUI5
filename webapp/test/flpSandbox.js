		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapphircreatereservation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapphircreatereservation-display": {
								"semanticObject": "sapphircreatereservation",
								"action": "display",
								"description": "Kreiranje rezervacije",
								"title": "Create reservation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapphir.createreservation",
									"url": sap.ui.require.toUrl("sapphir/createreservation")
								}
							}
						}
					}
