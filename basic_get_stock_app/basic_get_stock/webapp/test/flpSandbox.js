		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pregled zaloge",
									"targetURL": "#sapphirbasicgetstock-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapphirbasicgetstock-display": {
								"semanticObject": "sapphirbasicgetstock",
								"action": "display",
								"description": "Pregled zaloge na mobilnih napravah",
								"title": "Pregled zaloge",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapphir.basicgetstock",
									"url": sap.ui.require.toUrl("sapphir/basicgetstock")
								}
							}
						}
					}
